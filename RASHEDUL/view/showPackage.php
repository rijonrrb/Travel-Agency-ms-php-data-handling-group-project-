...
<head>
	...
	<script src="../RASHEDUL/view/js/allPackage.js"></script>
</head>
<body>
<?php
session_start();
...
<?php
	...
	<form  action="../RASHEDUL/controller/showPackagAction.php" method = "GET" name="form" onsubmit="ajax(this);return false;">
		<fieldset>
